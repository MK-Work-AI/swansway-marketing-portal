...
// BB_PESO
const BB_PESO = {
  P:{ label:'Paid',   color:'#FF6B35', sub:'You pay for distribution',   channels:[{id:'google',name:'Google Search PPC',base:25,ev:5,fleet:-5,brand:-10},{id:'meta',name:'Paid Social (Meta/TikTok/LinkedIn)',base:20,ev:5,fleet:-10,brand:5},{id:'autotrader',name:'AutoTrader PPC & Listings',base:15,fleet:-10,brand:-15},{id:'youtube',name:'YouTube Pre-Roll',base:0,ev:8,brand:10,launch:8},{id:'tiktok',name:'TikTok',base:0,seat:12,cupra:8},{id:'linkedin',name:'LinkedIn B2B',base:0,fleet:25}] },
