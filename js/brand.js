...
function renderBrandChannelMix(brandId) {
  ...
  // Legend
  html += '<div style="display:flex;align-items:center;gap:20px;padding:8px 20px 14px;flex-wrap:wrap;border-bottom:1px solid var(--border)">';
  ...
  html += '<div><strong>Allocation bars:</strong> top = planned as % of budget &nbsp;|&nbsp; bottom = % committed to campaigns</div></div>';
  html += '<div style="font-size:10px;color:var(--ink-soft);display:flex;align-items:center;gap:12px">';
  ...
  html += '<span style="display:flex;align-items:center;gap:4px"><span style="width:8px;height:8px;border-radius:2px;background:#DC2626;display:inline-block"></span>Over</span>';
  html += '</div>';
  html += '</div>';
